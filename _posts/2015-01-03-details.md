...
**Description:** This short module is designed to give students familiar with programming a basic introduction to the python language.
...
**Description:** Everyone knows how to use a spreadsheet, but most people use them terribly inefficiently.
...
**Description:** SPSS can be very useful for simple data exploration to advanced statistics. It is widely used at CAMH and is a tool worth knowing.
...
**Instructor:** Steve & Navona <br>
**Helper:** Kyle

**Description:** REDCap is a web application for building and managing surveys and databases, and requires little programming knowledge. 
...
**Description:** We are accessing websites in our everyday life for any type of reason. Learn what are the foundations of those websites.
**You'll learn:** 
...
**Description:** SQL underlies so much of database work, it's crucial to get a handle on it
...
Note: This workshops is also offered on October 5th, 1-3pm

**Instructors:** Steve & Navona <br>
**Helper:** Kyle
