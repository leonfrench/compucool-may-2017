...
<div class="card-body" markdown="1">
Note: This workshops is also offered on Thursday Oct 13th, 9-11am
...
<div class="card-body" markdown="1">
Note: This workshops is also offered on Wednesday Oct 12th, 9-11am
...
<div class="card-body" markdown="1">
We are accessing websites in our everyday life for any type of reason. Learn what are the foundations of those websites.
**You'll learn:** 
...
<div class="card-body" markdown="1">
Note: This workshops is also offered on Wednesday October 12th, 1:00pm-3:00pm

R is a free, featureful and sometimes magical language for doing statistical analysis. This workshop will introduce you to R and the Rstudio environment. 
...
**You'll learn:** 
- Understand how to build a database, 
- how to enter data into a database, 
- constructing queries for selecting, filtering, joining table, 
- calculating basic statistics. 
- Basic normalization principles. 
- Basic SQL syntax language.
...
<div class="card-body" markdown="1">
Note: This workshops is also offered on Thusday October 6th, 9-11am.

R is a free, featureful and sometimes magical language for doing statistical analysis. This workshop will introduce you to R and the Rstudio enviroment.
...
<div class="card-body" markdown="1">
You know the basic functionality of R, but the hardest part is getting your data in order. In this workshop you’ll learn some fundamental ways of organizing and manipulating datasets, as well as visualising your data. 
...
<div class="card-body" markdown="1">
Note: This workshops is also offered on Wednesday October 11th, 11-1pm
...
<div class="card-body" markdown="1">
You know the basic functionality of R, now let's actually run some statistical tests.
...
You’re probably used to creating posters in MS PowerPoint, which is all well and good. If you’d like to take your posters to the next level, however, you’ll need something with a little more power under the hood. With its powerful image and text-editing capabilities, and fine control over layers and groups, Photoshop is an excellent option!
